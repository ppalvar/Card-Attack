...
/// <summary>
/// This file uses grammars in the Backus-Naur notation like following:
/// 
/// (For more info visit https://en.wikipedia.org/wiki/Backus%E2%80%93Naur_form)
/// 
/// 
...
//
//
// if_statement : IF L_PAREN condition R_PAREN compound (ELSE conditional | compound)
//
// while_cicle : WHILE L_PAREN condition R_PAREN compound
//
// variable_declaration : INT | BOOL | STRING identifier (COMMA identifier)*
//
// compound_statement : L_BRACE statement_list R_BRACE
//
// assignment_statement : identifier ASSIGN value
//
// empty : --
//
// value : conj (OR conj)*
...
//          | prop
// 
// prop : object (L_PAREN value R_PAREN) (DOT object)*
///
/// This forms are then transcripted into the methods below. The behavior
/// of the methods is equal to their coresponding grammar so it's no needed a 
/// further explamation
/// 
/// /// </summary>
...
/// <summary>
/// This class makes an Abstract Syntax Tree (AST) for the input program
/// </summary>
public class Parser
{
